export default function MyProfileSkeleton() {
  return (
    <div className='flex h-[530px] w-[280px] animate-pulse flex-col items-center justify-between rounded-[16px] border border-gray-300 bg-gray-100 px-[20px] py-[39px] shadow-drop tablet:h-[247px] tablet:w-full tablet:px-[40px] tablet:py-[23px] mobile:h-[241px] mobile:p-[20px]'>
