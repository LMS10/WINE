export default function MyReviewItemSkeleton() {
  return (
    <div className='flex w-[800px] rounded-[16px] border border-gray-300 bg-gray-100 px-10 py-7 tablet:w-full mobile:w-full'>
      <div className='flex flex-grow flex-col gap-[20px]'>
        <div className='relative flex animate-pulse gap-[15px]'>
