...
import ReviewListTasteItem from './ReviewListTasteItem';
...
export default function ReviewItem({ review }: ReviewItemProps) {
  ...
  return (
    <div className='mb-[20px] min-h-[200px] w-[800px] rounded-lg border-[1px] border-solid border-gray-300 pb-[20px] pl-[40px] pr-[40px] pt-[30px]'>
      <div className='mb-[20px] flex justify-between'>
        <div className='flex gap-[16px]'>
          ...
          <div>
            ...
            <div className='text-lg font-normal text-gray-500'>{review.createdAt}</div>
          </div>
        </div>
      ...
      <div className='flex justify-between'>
        ...
        <div className='flex items-center gap-[4.5px] rounded-[10px] bg-purple-10 px-[15px] py-[8px]'>
          ...
          <div className='text-lg font-bold text-purple-100'>{review.rating}</div>
        </div>
      </div>
      ...
      <div className={`overflow-hidden transition-[max-height] duration-300 ${isOpen ? 'max-h-[1000px]' : 'max-h-0'}`}>
        {isOpen && (
          <div className='mt-[24px]'>
            ...
            <ReviewListTasteItem isDraggable={false} lightBold={review.lightBold} smoothTannic={review.smoothTannic} drySweet={review.drySweet} softAcidic={review.softAcidic} />
